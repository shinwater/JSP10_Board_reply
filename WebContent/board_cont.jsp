				...
				<tr>
					<td colspan="2" align="center">
						<input type="button" value="글수정"
							onclick="location.href='board_edit.do?no=${dto.getBoard_no() }'">
						<input type="button" value="글삭제"
							onclick="location.href='board_del.do?no=${dto.getBoard_no() }'">
						<input type="button" value="글답변"
							onclick="location.href='board_reply.do?no=${dto.getBoard_no() }'">
